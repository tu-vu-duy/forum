...
KSUtils.prototype.findFirstDescendantByClass = function(parent, classChild) {
	var list = eXo.ks.KSUtils.findDescendantsByClass(parent, classChild);
...
KSUtils.prototype.findDescendantsByClass = function(parent, classChild) {
	...
	while (i--) {
		if (DOMUtil.hasClass(elements[i], classChild))
			allchildrents.push(elements[i]);
	}
...
eXo.ks.EventManager = new EventManager();
