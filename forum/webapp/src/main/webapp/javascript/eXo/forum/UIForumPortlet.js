...
;(function($, window, document) {
  ...
  UIForumPortlet.prototype.init = function(id) {
    ...
    eXo.core.Browser.addOnResizeCallback(id, eXo.forum.UIForumPortlet.resizeCallback)
    eXo.core.Browser.init();
  };

  UIForumPortlet.prototype.resizeCallback = function() {
    eXo.forum.ForumUtils.setMaskLayer(eXo.forum.UIForumPortlet.id);
  };
  ...
  UIForumPortlet.prototype.showPopup = function(elm, e) {
...
//      var posX = 24*2 - uiPopupCategory.offsetWidth ;
  ...
  window.eXo.forum.UIForumPortlet = new UIForumPortlet() ;
})(gj, window, document);
